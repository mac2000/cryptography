...
// const privateKey = crypto.createPrivateKey({key: fs.readFileSync('private.pem', 'utf8'), format: 'pem', type: 'sec1'})

const privateKey = crypto.createPrivateKey(fs.readFileSync('private.pem', 'utf8'))

const decrypted = crypto.privateDecrypt({key: privateKey, padding: crypto.constants.RSA_PKCS1_OAEP_PADDING}, Buffer.from(encrypted, 'base64'))
